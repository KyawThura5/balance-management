...
<li class="nav-item ${title eq 'INCOMES' ? 'active' : '' }">
...
<li class="nav-item ${title eq 'EXPENSES' ? 'active' : '' }">
<a href="${root }/member/entry/expenses" class="nav-link">
<i class="bi-cart"></i>Expenses
</a>
</li>

<li class="nav-item ${title eq 'LEDGERS' ? 'active' : '' }">
<a href="${root }/member/ledger" class="nav-link">
