...
import com.online.balances.controller.member.dto.BalanceSearch;

@Controller
@RequestMapping("member/balance")
public class MemberReportForBalanceController {
	@GetMapping
	String index(ModelMap model, BalanceSearch search, @RequestParam(required = false, defaultValue = "0") int page,
